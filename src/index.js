...
// Juntando os nomes com a mensagem de boas-vindas
       ...
       //seu código
var joaosilva = nome + "" + sobrenome;

// Exibindo a mensagem no console
console.log("bem-vindos, " + joaosilva);
...
// Exibindo o resultado no console
console.log("O funcionário viveu aproximadamente... dias " + idadeemdias);
...
// Calculando horas e minutos
      ...
      //seu código
var horas = parseInt(duracaoEmMinutos / 60);
var minutos = duracaoEmMinutos % 60;

// Exibindo o resultado no console
console.log("O evento durou ...horas e ... minutos." + horas + " horas e " + minutos + " minutos. ");
